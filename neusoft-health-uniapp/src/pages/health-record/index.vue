<template>
  <view class="page">
    <NavHeader title="健康档案" showBack @back="goBack" />
...
const items = ref([{'text': '身高', 'time': '170 cm', 'count': ''}, {'text': '体重', 'time': '65 kg', 'count': ''}, {'text': '血型', 'time': 'A型', 'count': ''}, {'text': '过敏史', 'time': '青霉素', 'count': ''}])
